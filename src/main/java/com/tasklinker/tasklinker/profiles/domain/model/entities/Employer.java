...
import com.tasklinker.tasklinker.profiles.domain.model.valueobjects.CompanyDetails;
import com.tasklinker.tasklinker.profiles.domain.model.valueobjects.FullName;
import com.tasklinker.tasklinker.profiles.domain.model.valueobjects.Industry;
import com.tasklinker.tasklinker.profiles.domain.model.valueobjects.PaymentMethod;
import com.tasklinker.tasklinker.profiles.domain.model.valueobjects.PhoneNumber;
import com.tasklinker.tasklinker.profiles.domain.model.valueobjects.Photo;
...
public class Employer extends AuditableAbstractAggregateRoot<Employer> {
    ...
    public Employer(String firstname, String lastname, String location, String name, int numberOfEmployees,
            String website, String industryName, String countryCode, String number, String photoUrl,
    ...
    public Employer(CreateEmployerCommand command) {
        ...
        this.companyDetails = new CompanyDetails(command.location(), command.name(), command.numberOfEmployees(),
                command.website());
