...
public class Employer extends AuditableAbstractAggregateRoot<Employer> {
    ...
    public String getCompanyDetails() {return companyDetails.getCompanyDetails();}
    public String getIndustryName() {return industry.getIndustryName();}
    public String getPhoneNumber() {return phoneNumber.getPhoneNumber();}
    public String getPhoto(){return photo.getPhoto();}
    public String getPaymentMethod(){return paymentMethod.paymentMethod();}
